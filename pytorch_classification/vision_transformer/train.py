...
def main(args):
    ...
    model = create_model(
        num_classes=args.num_classes, has_logits=False).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data-path',
        type=str,
        default=r"C:\Users\zhangjin\Documents\GitHub\flower_photos")
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        r'C:\Users\zhangjin\Documents\GitHub\deep-learning-for-image-processing\pytorch_classification\vision_transformer\jx_vit_base_patch16_224_in21k-e5005f0a.pth',
